...
class AnimeStatModel extends ChangeNotifier {
  ...
  final List<RankInfo> _ranks = [
    const RankInfo(name: "Otaku-chaaan", threshold: 0, color: Color(0xFFC7F141)),
    ...
    const RankInfo(name: "Leaker One Piece", threshold: 15, color: Colors.white),
    ...
    const RankInfo(name: "El Psy Kongroo", threshold: 35, color: Colors.blueAccent),
    ...
    const RankInfo(name: "Sakura Hate Club", threshold: 60, color: Color(0xFFFF6B9D)),
    const RankInfo(name: "Aura Farmer", threshold: 65, color: Color(0xFF000080)),
    const RankInfo(name: "No Enemies", threshold: 70, color: Colors.lightBlueAccent),
    ...
    const RankInfo(name: "Le Roi des Pirates", threshold: 100, color: Color(0xFFFFD700)),
  ];
  ...
  void _updateRank() {
    ...
    final int totalScore = ScreenTimeProvider.getTotalScreenTime() + LikeStorage.getIdAnimeLiked().length + UserStatsProvider.getAnimeViewsCount();
